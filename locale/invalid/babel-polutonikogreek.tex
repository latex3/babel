...
\BabelBeforeIni{el-polyton}{%
  \expandafter\def\csname bbl@preini@polutonikogreek\endcsname{%
    \csname bbl@error\endcsname{invalid-ini-name}{polutonikogreek}{polytonicgreek}{}%
    }%
  \BabelDefinitionFile{0}{greek}{%
    \PackageWarning{babel}{%
      Name 'polutonikogreek' is deprecated.\MessageBreak
      Use 'polytonicgreek' instead.\MessageBreak
      Reported}%
    \def\languagename{greek}%
    \AtEndOfPackage{\languageattribute{greek}{polutoniko}}%
    \AddBabelHook[polutoniko]{babel-greek}{languagename}{%
      \def\languagename{greek}}%
